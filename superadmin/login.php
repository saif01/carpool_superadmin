    ...
    while($row=mysqli_fetch_array($ret))
                {   
                    ...
                    {  
                        ...
                        $_SESSION['SadminName']=$_POST['SadminName'];
			...
			elseif($st==0)
			    {
			        ...
			        $_SESSION['SadminName']=$_POST['SadminName'];
			         ...
			         $log=mysqli_query($con,"INSERT INTO `loginlog`(`user_name`, `user_ip`, `user_os`, `user_browser`, `user_device`) VALUES ('".$_SESSION['SadminName']."','$ip','$rowcount','$browser','$device')");
